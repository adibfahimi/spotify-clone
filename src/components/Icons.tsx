function Logo() {
  return (
    <svg viewBox="0 0 1134 340" className="w-max-[131px] h-10 text-white">
      <path
        fill="currentColor"
...
function ActiveHomeIcon() {
  return (
    <svg role="img" height={24} width={24} viewBox="0 0 24 24" fill="#fff">
...
function PlaylistIcon() {
  return (
    <div className="flex h-6 w-6 items-center justify-center rounded-sm bg-white p-1 ">
      <svg role="img" height={12} width={12} viewBox="0 0 16 16" fill="#000">
...
function LikeIcon() {
  return (
    <div className="flex h-6 w-6 items-center justify-center rounded-sm bg-gradient-to-b from-[#450af5] to-[#c4efd9] p-1 ">
      <svg role="img" height={12} width={12} viewBox="0 0 16 16" fill="#fff">
...
function ChevronRightIcon() {
  return (
    <svg role="img" height="22px" width="22px" fill="#fff" viewBox="0 0 24 24">
...
function ChevronDownIcon() {
  return (
    <svg role="img" height={16} width={16} viewBox="0 0 16 16" fill="#fff">
